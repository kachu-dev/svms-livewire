    ...
    <body class="min-h-screen bg-zinc-50 antialiased dark:bg-zinc-800">
        ...
        >
            ...
            <flux:sidebar.nav>
                ...
                >
                    <flux:sidebar.item href="{{ route('student.violations.index') }}" wire:navigate>
                        Violation History
                    </flux:sidebar.item>
                    <flux:sidebar.item href="{{ route('student.policy.display-policy') }}" wire:navigate>
                        All Violation Policy
                    </flux:sidebar.item>
                </flux:sidebar.group>
