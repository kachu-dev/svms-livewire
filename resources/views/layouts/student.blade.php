        ...
        <flux:header class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="-mb-px max-lg:hidden">
                <flux:navbar.item
                    ...
                    icon="home"
                    wire:navigate
                >My Violation History</flux:navbar.item>
                <flux:navbar.item
                    href="{{ route('student.policy.display-policy') }}"
                    icon="document"
                    wire:navigate
                >Policies</flux:navbar.item>
            </flux:navbar>
        ...
        >
            ...
            <flux:sidebar.nav>
                <flux:sidebar.item
                    ...
                    icon="home"
                    wire:navigate
                >My Violation History</flux:sidebar.item>
                <flux:sidebar.item
                    href="{{ route('student.policy.display-policy') }}"
                    icon="document"
                    wire:navigate
                >Policies</flux:sidebar.item>
            </flux:sidebar.nav>
