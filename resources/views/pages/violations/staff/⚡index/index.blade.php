<div>
    <x-table-wrapper heading="Pending Records">
        ...
        <x-slot:actions>
            <flux:modal.trigger name="update-school-year">
                <flux:button>Update School Year</flux:button>
            </flux:modal.trigger>
        ...
        >
            <div class="space-y-6">
                @if (!$passwordConfirmed)
                    <div>
                        <flux:heading size="lg">Update School Year</flux:heading>
                        <flux:text class="mt-2 text-zinc-500">Confirm your password to proceed.</flux:text>
                    </div>
                ...
                @else
                    <flux:text class="text-sm text-zinc-500">
                        Current school year: <strong>{{ $schoolYear }}</strong>
                    </flux:text>
                    ...
                    <div class="grid grid-cols-[1fr_auto_1fr] items-end gap-2">
                        ...
                        <flux:input
                            ...
                            placeholder="2026"
                            type="number"
                            wire:model="newYearTo"
                        />
                    </div>
                    <flux:button
                        class="w-full"
                        variant="primary"
                        wire:click="updateSchoolYear"
                    >
                        Update School Year
                    </flux:button>
                @endif
