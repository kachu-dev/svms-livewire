                        ...
                        <flux:table.row>
                            ...
                            <flux:table.cell>
                                <flux:dropdown position="left">
                                    ...
                                    <flux:menu>
                                        <flux:menu.item
                                            href="/policy/{{ $policy->id }}/update"
                                            wire:navigate
                                            icon="arrow-path">Update
                                        </flux:menu.item>
                                        <flux:menu.item wire:click="deactivate({{ $policy->id }})" icon="archive-box-x-mark">Deactivate</flux:menu.item>
                                        <flux:menu.separator />
                                    </flux:menu>
                                </flux:dropdown>
                            </flux:table.cell>
